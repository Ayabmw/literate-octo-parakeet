 ...
 */
final class Version20231019142913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD author_id INT DEFAULT NULL, ADD id_author_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP author_id, DROP id_author_id');
    }
}
